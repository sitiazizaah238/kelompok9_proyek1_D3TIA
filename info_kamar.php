...
Kamar luas dengan ukuran 4x5 meter
Tempat tidur single dengan kasur empuk
...
Lokasi Strategis:
5 menit berjalan kaki ke kampus Polindra
Dekat dengan area-area warung makan
Lingkungan yang aman dan nyaman

Harga Sewa:
Rp 500.000 per bulan (sudah termasuk listrik dan air)
Deposit sebesar 1 bulan sewa

Kontak:
Nomor Telepon/WhatsApp: 0812-3456-7890
Email: sewakost@example.com</p>
    <div class="container">
        ...
        <h1 class="room-title"><?php echo $no_kamar; ?></h1>
        <p class="room-description"><?php echo $deskripsi; ?></p>

        <div class="room-details">
            <?php if (!empty($harga)) : ?>
                <div class="detail-item"><strong>Harga:</strong> Rp <?php echo number_format($harga, 0, ',', '.'); ?>/bulan</div>
            <?php endif; ?>
            <div class="detail-item"><strong>Lokasi:</strong> <?php echo $lokasi; ?></div>
        </div>
